#include "../include/avx256/sort_util.h"
...
template void SortBlock16<uint64_t, __m256i>(uint64_t *&arr, size_t offset);
...
template void MaskedSortBlock2x4<uint64_t, __m256i>(uint64_t *&arr, size_t offset);
}
#endif
