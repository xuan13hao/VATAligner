#include "../include/avx256/merge_util.h"
...
// template void MergeRuns4<uint64_t, __m256i>(uint64_t *&arr, size_t N);
...
template void MaskedMergeRuns4<uint64_t, __m256i>(uint64_t *&arr, size_t N);
...
template void MergePass4<uint64_t, __m256i>(uint64_t *&arr, uint64_t *buffer, size_t N, unsigned int run_size);
...
template void MaskedMergePass4<uint64_t, __m256i>(uint64_t *&arr, uint64_t *buffer, size_t N, unsigned int run_size);
}
