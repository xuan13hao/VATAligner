...
# 2:29211790-29211949_10_14_0_1_0_0_0:0:0_3:0:0_0 
# 2:15999445-15999605_13_50_0_1_0_0_4:0:0_3:0:0_0/1
# 3:11344972-11345126_31_50_0_1_0_0_2:0:0_1:0:0_0
# >2:10252964-10252976
def readReadName(input_file): # truth
    ...
    for fasta in fasta_sequences:
        seq_id = str(fasta.id)
        new_name = re.sub('/(\d)','',seq_id) # for bwa and star format
        # print(new_name)
        seq_name = fasta.id
        l = len(fasta.seq)
        ...
        seq_name = m.group(1)
        # print(seq_name)
        m_ = re.match(r'(.*):(\d+)-(\d+)', seq_name)
        pos = m_.group(2)
        s = int(pos) + int(m.group(2))
        e = s + l
        # print(s,":",e)
        truth[new_name] = (s,e) 
    # print(truth)
