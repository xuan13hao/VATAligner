...
struct SeedChainType   {
    std::vector<DiagonalSeeds<_locr, _locl> > chain;
...
template<typename _locr, typename _locl>
vector<DiagonalSeeds<_locr, _locl> > findOptimalSeeds(vector<DiagonalSeeds<_locr, _locl> >& diagonal_segment,int q_len,int max_gap)
{
...
template<typename _locr, typename _locl>
void findSeedChain(vector<DiagonalSeeds<_locr, _locl> >& diagonal_segment,vector<SeedChainType<_locr, _locl> >& seed_chains,int q_len)
{
...
template<typename _locr, typename _locl>
vector<DiagonalSeeds<_locr, _locl> > chainingSeeds(vector<DiagonalSeeds<_locr, _locl> >& diagonal_segment,int q_len,int max_gap)
{
