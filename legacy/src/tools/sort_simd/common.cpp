...
template void aligned_init<>(int* &ptr, size_t N, size_t alignment_size);
template void aligned_init<unsigned>(unsigned* &ptr, size_t N, size_t alignment_size);
template void aligned_init<uint64_t>(uint64_t* &ptr, size_t N, size_t alignment_size);
...
template void aligned_init<std::pair<uint64_t,uint64_t>>(std::pair<uint64_t,uint64_t>* &ptr, size_t N, size_t alignment_size);
template void aligned_init<Tuple>(Tuple* &ptr, size_t N, size_t alignment_size);
...
template void print_arr<uint64_t>(uint64_t* arr, int i, int j, const std::string &tag);
